...
final class FormatoAuditoria {
    ...
    private static final Map<String, String> ACCIONES = Map.ofEntries(
            ...
            Map.entry("CORREOVERIFICACIONENVIADA", "Correo de verificación enviado"),
            Map.entry("CORREOVERIFICACIONFALLIDA", "Envío de verificación fallido"),
            Map.entry("CORREOVERIFICADO", "Correo verificado"),
            ...
            Map.entry("IMAGENEVENTOSECUNDARIAAGREGADA", "Imagen secundaria de evento agregada"),
            Map.entry("IMAGENEVENTOSECUNDARIAELIMINADA", "Imagen secundaria de evento eliminada"),
            ...
            Map.entry("PORTADAPUBLICACIONACTUALIZADA", "Portada de publicación actualizada"),
